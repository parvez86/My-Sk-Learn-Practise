...
model_reg = make_pipeline(PolynomialFeatures(degree=2), StandardScaler(), SGDRegressor(max_iter=1000, tol=1e-3))
...
print('Model coefficients: ', model_reg['sgdregressor'].coef_)
print('Model intercepts: ', model_reg['sgdregressor'].intercept_)